    ...
    'pedidos' => [
        ...
        'submenu' => [
            [
                ...
                'itens' => [
                    ['label' => 'Lista de Pedidos', 'url' => 'pedidos.php', 'badge' => 'pedidos_novos'],
                    ['label' => 'Novo Pedido', 'url' => 'pedido_novo.php'],
                    ['label' => 'Orçamentos', 'url' => 'orcamentos.php', 'badge' => 'orcamentos_pendentes'],
            ...
            [
                ...
                'itens' => [
                    ['label' => 'Kanban Produção', 'url' => 'producao.php'],
    ...
    'clientes' => [
        ...
        'submenu' => [
            [
                ...
                'itens' => [
                    ['label' => 'Lista de Clientes', 'url' => 'clientes.php'],
                    ['label' => 'Novo Cliente', 'url' => 'cliente_novo.php'],
    ...
    'produtos' => [
        ...
        'submenu' => [
            [
                ...
                'itens' => [
                    ['label' => 'Lista de Produtos', 'url' => 'catalogo.php'],
                    ['label' => 'Novo Produto', 'url' => 'catalogo_produto_novo.php'],
                    ['label' => 'Importar Produtos', 'url' => 'catalogo_importar.php'],
                    ['label' => 'Atualização de Preços', 'url' => 'catalogo_precos.php'],
                    ['label' => 'Categorias', 'url' => 'categorias.php']
                ]
            ],
            [
                'label' => 'Estoque',
                ...
                'itens' => [
                    ['label' => 'Posição de Estoque', 'url' => 'estoque.php'],
                    ['label' => 'Movimentações', 'url' => 'estoque_movimentos.php']
                ]
            ],
            [
                'label' => 'Fornecedores',
...
function contarBadge($tipo) {
    ...
    $badges = [
        ...
        'aprovacoes' => "SELECT COUNT(*) FROM pedidos WHERE status = 'aguardando_aprovacao'",
              ...
              <div class="relative">
                ...
                >
                  <?php if ($modoVerComo): ?>
                    ...
                    <a href="ver_como_desativar.php" class="block px-4 py-2 text-sm text-purple-700 hover:bg-purple-50 dark:hover:bg-purple-900/20">
                  ...
                  <?php else: ?>
                    <a href="perfil.php" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white">Meu Perfil</a>
                    <a href="configuracoes_usuario.php" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white">Configurações</a>
                  <?php endif; ?>
                  <hr class="my-1 border-gray-200 dark:border-gray-600">
                  <a href="logout.php" class="block px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-800 dark:hover:text-red-300">Sair</a>
                </div>
              </div>
            </div>
          </div>
