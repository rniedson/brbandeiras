...
<div class="flex-1 bg-gray-50" x-data="dashboardVendedor()">
    <div class="p-6">
        ...
        <div class="bg-white p-4 rounded-xl mb-6 flex items-center gap-4 shadow-sm border">
            ...
            <div class="ml-auto">
                <a href="<?= $baseUrl ?>pedidos/pedido_novo.php" class="bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-2 rounded-lg inline-flex items-center gap-2 transition-all shadow-md">
                        ...
                        <tr>
                            <td colspan="8" class="p-12 text-center text-gray-500">
                                <div class="flex flex-col items-center gap-4">
                                    ...
                                    <a href="<?= $baseUrl ?>pedidos/pedido_novo.php" class="bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-3 rounded-lg inline-flex items-center gap-2">
                                        <i class="fas fa-plus"></i>
                                        Criar OS
                                    </a>
                                </div>
