...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Novo Cliente</h1>
        <p class="text-gray-600 mt-2">Cadastre um novo cliente no sistema</p>
    </div>
    
    <form method="POST" action="cliente_salvar.php" onsubmit="return showLoading(this)"
          x-data="{ 
              tipoPessoa: 'J',
              cep: '',
              buscandoCep: false,
