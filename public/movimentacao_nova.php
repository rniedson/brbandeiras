...
$produtos = $pdo->query("
    SELECT id, codigo, nome, quantidade_atual, unidade_medida 
...
$pedidos = $pdo->query("
    ...
    WHERE p.status IN ('producao', 'finalizado') 
                    ...
                    <div class="col-span-6">
                        <select x-model="item.produto_id" 
                            ...
                            <option value="<?= $produto['id'] ?>" 
                                ...
                                (Estoque: <?= number_format($produto['quantidade_atual'], 2, ',', '.') ?> <?= $produto['unidade_medida'] ?>)
                            </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
